    ...
    then(onResolved, onRejected) {
        ...
        if (this.state === this.PENDING) {
            ...
            promise2 = new MyPromise((resolve, reject) => {
                ...
                resCallBacks.CurPromiseUid = MyPromise.id
                this.resolvedCallbacks.push(resCallBacks);
                let rejCallBacks = () => {
                    try {
                ...
                rejCallBacks.CurPromiseUid = MyPromise.id
                this.rejectedCallbacks.push(rejCallBacks);
            })
...
const promise = new MyPromise(function promise1(resolve /* 从Promise的方法中传递出来的 */ , reject) {
